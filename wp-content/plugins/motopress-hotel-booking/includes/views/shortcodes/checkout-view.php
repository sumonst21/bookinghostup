...
class CheckoutView {
	 ...
	 */
 	...
 	public static function renderRoomLocation( $roomType, $roomIndex, $booking ){

 	 	?>

	 	<p class="mphb-room-location">

		 	<small>

			 	<?php _e( '*This room is located on ', 'motopress-hotel-booking' ); ?>

		 	</small>

		 	<small class="mphb-room-type-location">

			 	<?php echo $booking->getMlscRoomLocation($roomIndex); ?>
 ...
 /** HostUP end **/
	...
	public static function renderTermsAndConditions($booking){

		$termsPageId = MPHB()->settings()->pages()->getTermsAndConditionsPageId();
		$termsHtml   = MPHB()->settings()->main()->getTermsAndConditionsText();

		/* Host-UP different policies per accommodation */

		$mlscCat = $booking->mlsc_getCategory();

		switch ($mlscCat[0]) {
    case 'HBG':
        $mlsc_content = "/cancellation-policy-HBGHSHB";
        break;
    case 'HS':
        $mlsc_content = "/cancellation-policy-HBGHSHB";
        break;
    case 'HB':
        ...
        break;
		case 'BLAIV':
				$mlsc_content = "/cancellation-policy-BLAIVBLAIII";
				break;
		case 'BLAIII':
				$mlsc_content = "/cancellation-policy-BLAIVBLAIII";
				break;
		...
		$termsHtml .= '<div class="mlsc_term"><a target="_blank" href="' . $mlsc_content . '">' . __( 'View Details', 'motopress-hotel-booking' ) . '</a></div>';
	...
	public static function renderCustomerDetails(){
		...
		<section id="mphb-customer-details" class="mphb-checkout-section">
			...
			<?php /** Hostup - 20190225 - Document_id customization */?>

			<p class="mphb-customer-documentId">

				<label for="mphb_documentId">

					<?php _e( 'Document Id', 'motopress-hotel-booking' ); ?>
				...
				<small>
					...
					<?php printf( __( '(Passport, National ID, Driver License, etc)', 'motopress-hotel-booking' ), '<abbr title="required">*</abbr>' ); ?>
			...
			<?php if ( MPHB()->settings()->main()->isRequireFullAddress() ) : ?>
				...
				<p class="mphb-customer-state">
					...
					<input type="text" name="mphb_state" required="required" id="mphb_state" accept=".xls,.xlsx" />
			 ...
			 if ( count( $gateways ) > 1 ) {
				 ...
				 <ul class="mphb-gateways-list">
					 ...
					 foreach ( $gateways as $gateway ) {
						 ...
						 <!-- HostUP - Payment Item Customization -->
...
-->
						...
						<!-- HostUP - Payment Item Customization END -->
						 ...
						 <li class="mphb-gateway mphb-gateway-<?php echo $gateway->getId(); ?>">
							 ...
							 <div class="mlsc-payment-icon">

								<img class="mlsc-paypal-icon" width="128" height="128" src="<?php bloginfo('wpurl'); ?>/wp-content/uploads/2019/02/paypal-icon-payment.jpg">

							 	<img class="mlsc-stripe-icon" width="128" height="128" src="<?php bloginfo('wpurl'); ?>/wp-content/uploads/2019/02/stripe-icon-adjusted.png">
	...
	public static function renderCheckInDate( $booking ){
		...
		<p class="mphb-check-in-date">
			...
			<span>
				...
				<b class="mlsc_checktime"> <?php _ex( 'from', 'from 10:00 am', 'motopress-hotel-booking' ); ?> </b>

			</span>

		<!-- HostUP - 20190218 - Cstomize check in/out date
		...
		-->
			...
			<time datetime="<?php echo $booking->mlsc_getCheckInTime(); ?>">

				<b class="mlsc_checktime"> <?php echo $booking->mlsc_getCheckInTime(); ?> </b>
	...
	public static function renderCheckOutDate( $booking ){
		...
		<p class="mphb-check-out-date">
			...
			<span>
				...
				<b class="mlsc_checktime"> <?php _ex( 'until', 'until 10:00 am', 'motopress-hotel-booking' ); ?> </b>
	...
	<!-- HostUP - 20190218 - Cstomize check in/out date
		...
		-->
			...
			<time datetime="<?php echo $booking->mlsc_getCheckOutTime(); ?>">

				<b class="mlsc_checktime"> <?php echo $booking->mlsc_getCheckOutTime(); ?> </b>
	...
	public static function renderCheckoutForm( $booking, $roomDetails ){
		...
		<?php /** HostUp - 05.03.2019 - DocumentId - <form class="mphb_sc_checkout-form" method="POST" action="<?php echo esc_url( $actionUrl ); ?>"> */?>

		<form enctype="multipart/form-data" class="mphb_sc_checkout-form" method="POST" action="<?php echo esc_url( $actionUrl ); ?>">

...
class StepCheckout extends Step {
	...
	public function addInitActions(){
		...
		add_action( 'mphb_sc_checkout_room_details', array( '\MPHB\Views\Shortcodes\CheckoutView', 'renderRoomLocation' ), 10, 3 );		/**HostUP - Room Location (10,2) */
		...
		add_action( 'mphb_sc_checkout_form', array( '\MPHB\Views\Shortcodes\CheckoutView', 'renderTermsAndConditions' ), 60, 2 ); /**HostUP - renderTermsAndConditions (60, 0) */

		// Booking Details

		add_action( 'mphb_sc_checkout_form_booking_details', array( '\MPHB\Views\Shortcodes\CheckoutView', 'renderCheckInDate'), 10, 2 ); /**HostUP - Check in-out (10,2) */
		add_action( 'mphb_sc_checkout_form_booking_details', array( '\MPHB\Views\Shortcodes\CheckoutView', 'renderCheckOutDate' ) , 10, 2 ); /**HostUP - Check in-out (10,2) */

						...
						<!-- HostUP - Payment Item Customization END -->
						 ...
						 <li class="mphb-gateway mphb-gateway-<?php echo $gateway->getId(); ?>">
							 ...
							 <div class="mlsc-payment-icon">
								...
								<img class="mlsc-paypal-icon" width="128" height="128" src="http://localhost/hostup_dev/wp-content/uploads/2019/02/paypal-icon-payment.jpg">

							 	<img class="mlsc-stripe-icon" width="128" height="128" src="http://localhost/hostup_dev/wp-content/uploads/2019/02/stripe-icon-adjusted.png">
	...
	public static function renderCheckInDate( $booking ){
		...
		-->
			...
			<time datetime="<?php echo $booking->mlsc_getCheckInTime(); ?>">
				...
				<?php echo $booking->mlsc_getCheckInTime(); ?>
	...
	<!-- HostUP - 20190218 - Cstomize check in/out date
		...
		-->
			...
			<time datetime="<?php echo $booking->mlsc_getCheckOutTime(); ?>">
				...
				<?php echo $booking->mlsc_getCheckOutTime(); ?>

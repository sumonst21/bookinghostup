	...
	public function replaceTag( $match ){
		...
		switch ( $tag ) {
			...
			case 'site_title':
				...
				break;
			case 'check_in_time':
			/** Hostup 20190221 - Check in-out */
			//	$replaceText = MPHB()->settings()->dateTime()->getCheckInTimeWPFormatted();
			/** end */
				$checkintime = $this->booking->mlsc_getCheckInTime();
				$replaceText = $checkintime;
				break;
			case 'check_out_time':
			/** Hostup 20190221 - Check in-out */
			//	$replaceText = MPHB()->settings()->dateTime()->getCheckOutTimeWPFormatted();
			/** end */
				$checkouttime = $this->booking->mlsc_getCheckOutTime();
				$replaceText = $checkouttime;
				break;
